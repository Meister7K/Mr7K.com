...
export default function Home() {
  return (
      ...
      <main className="flex flex-col items-center justify-between w-full px-8 box-border min-h-screen">
        <section className="title flex flex-col justify-evenly align-middle relative w-full h-screen">
          <h1 className=" z-20 absolute top-5/6 w-full lg:text-9xl text-6xl text-center select-none">Welcome</h1>
